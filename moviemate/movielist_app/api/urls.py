...
from movielist_app.api.views import WatchListCreateAPIView, WatchDetailAPIView, StreamPlatformListAPIView, StreamPlatformDetailAPIView, ReviewListCreateAPIView, ReviewDetailAPIView, ReviewCreateAPIView
# urlpatterns = [
